...
--
-- Host: localhost
-- Generation Time: Oct 07, 2013 at 07:45 PM
...
INSERT INTO `app_user_users` (`id`, `name`, `email`, `username`, `password`, `bio`, `accessLevel`) VALUES
(175, 'Administrator', 'admin@site.com', 'adminstrator', '696d29e0940a4957748fe3fc9efd22a3', 'I am the site Administrator', 5);
...
(3, 'login', 'login', '', '', 'redirect==http://localhost/~brad/git/Sodapop/sodapop/user::registration==on', 0, 1),
(4, 'menu', 'menu', '', '', '', 1, 1);
